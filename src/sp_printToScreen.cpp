...
void sunpos::sp_printToScreen(void)
{
	...
	std::cout << "        Mean anomaly for " << planet << ": " << std::setw(jd_FLOATWIDTH) << std::setprecision(jd_FLOATPRECISION) << std::setfill(' ') << M << std::endl;
	std::cout << "  Equation of centre for " << planet << ": " << std::setw(jd_FLOATWIDTH) << std::setprecision(jd_FLOATPRECISION) << std::setfill(' ') << C << std::endl;
