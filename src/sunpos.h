...
class sunpos : public jdnMeeus1998 {

	short		spTz;
	int			spDst, spFLOATWIDTH, spFLOATPRECISION;
	bool		spVerbose;
	...
	void	spCalcSunDeclin(void);
	void	spCalcVarY(void);
	void	spCalcEqOfTime(void);
	void	spCalcHaSunrise(void);
