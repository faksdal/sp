...
void jdnMeeus1998::jdnPrintOutput(void)
{
	//
	...
	cout	<< "      Julian Day Number (jdn): " << setw(jdnFLOATWIDTH) << setprecision(jdnFLOATPRECISION) << setfill(' ') << jdnGetJdnJulianDay() << endl;
	cout	<< "    Julian Day Number at noon: " << setw(jdnFLOATWIDTH) << setprecision(jdnFLOATPRECISION) <<  jdnGetJdnNoon() << endl;
	/*
	cout	<< "     Julian Day Number midday: " << setw(FLOATWIDTH) << setprecision(FLOATPRECISION) << jdnGetJdnMeeusMidday() << endl;
